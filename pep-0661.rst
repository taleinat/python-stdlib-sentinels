...
A poll [3]_ was created on discuss.python.org to get a clearer sense of
...
The reference implementation is found in a dedicated GitHub repo [4]_.  A
...
Finally, this was a very unpopular option in the poll [3]_, with only 12%
...
poll [3]_, being the only option to receive no votes.
...
Also, in the poll [3]_ on this subject, the options for recommending an
...
.. [3] discuss.python.org Poll: `Sentinel Values in the Stdlib <https://discuss.python.org/t/sentinel-values-in-the-stdlib/8810/>`_
.. [4] `Reference implementation at the taleinat/python-stdlib-sentinels GitHub repo <https://github.com/taleinat/python-stdlib-sentinels>`_
