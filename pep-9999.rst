...
* The support for copying/unpickling only works when defined in a module's
  scope, but not in a class scope or in a function.  Is this acceptable and
  should just be documented?  Is this a significant issue?  Are there ways
  to avoid this issue?
